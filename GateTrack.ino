...
#define BLYNK_TEMPLATE_ID           "TMPL66mBzpZ5z"
#define BLYNK_TEMPLATE_NAME         "Quickstart Template"
#define BLYNK_AUTH_TOKEN            "SBHomU2aTQT4dwf4MGHX9uBXCoQEaPhx"
...
void sendMotionSensorData(){
  ...
  if (motionState == 1 && !motionDetected) {
    Blynk.logEvent("DoorOpen", "Motion detected!"); // Send notification
    motionDetected = true;
